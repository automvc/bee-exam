...
public class Update5_setNull {
	...
	public static void test() {
		...
		String Null=null;
//		condition.set(Orders_F.sequence, Null);  //set sequence=null
		condition.setNull(Orders_F.sequence); //2.0  //set sequence=null
		...
		orders.setSequence(null); // 放这里,默认不会处理(默认不处理null和空值)  
