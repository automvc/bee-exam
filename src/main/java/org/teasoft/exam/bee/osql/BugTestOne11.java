...
//			Orders a000=(Orders)obj[0];
			...
			Orders a00000=(Orders)jdks.unserialize(jdks.serialize(obj[0]));
			...
			e.printStackTrace();
			Logger.error("In BugTestOne11 (BeeException):"+e.getMessage());
		}catch (Exception e) {
			Logger.error("In BugTestOne11 (Exception):"+e.getMessage());
			e.printStackTrace();
		}
