...
*/
@Entity("Clazz")
public class Clazz011 implements Serializable {
...
//	@JoinTable(mainField="id", subField="classno", joinType=JoinType.LEFT_JOIN)
	@JoinTable(mainField="id", subField="classno", joinType=JoinType.LEFT_JOIN,subAlias="stu011")
//	@JoinTable(mainField="id", subField="classno", joinType=JoinType.RIGHT_JOIN)
	private List<Student011> studentList=new ArrayList<>();
...
//	}
	...
	public List<Student011> getStudentList() {
		return studentList;
	}

	public void setStudentList(List<Student011> studentList) {
