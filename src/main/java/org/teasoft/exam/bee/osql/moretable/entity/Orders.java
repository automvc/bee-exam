...
//	@JoinTable(mainField="userid", subField="username", joinType=JoinType.LEFT_JOIN)  //ok //... from orders left join test_user on orders.userid=test_user.username where ...
	@JoinTable(mainField="userid", subField="username", joinType=JoinType.LEFT_JOIN, subClass = TestUser.class)  //ok //... from orders left join test_user on orders.userid=test_user.username where ...
