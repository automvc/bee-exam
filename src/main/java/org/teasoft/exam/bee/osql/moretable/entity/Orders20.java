...
*/
@Table("orders")
public class Orders20 implements Serializable {
...
//		 if(testUser==null)
//			 str.append(",testUser").append("=null");	
//		 else 
//		   str.append(",").append(testUser.toString());
		 
		 if(assignexam==null)
			 str.append(",assignexam").append("=null");	
		 else 
		   str.append(",").append(assignexam.toString());
