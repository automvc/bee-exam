package org.teasoft.exam.moretable26.moretable3.entity;
...
*/
//@Table("orders")
public class Orders2026 implements Serializable {
...
//	@JoinTable3(mainField = { "userid", "name" }, subField = { "username", "name" }, joinType = JoinType.JOIN, subClass=TestUser.class)
	@JoinTable(mainField = { "userid", "name" }, subField = { "username", "name" }, joinType = JoinType.JOIN)
//	@JoinTable3(mainField = { "userid", "name" }, subField = { "username", "name" }, joinType = JoinType.WHERE)
