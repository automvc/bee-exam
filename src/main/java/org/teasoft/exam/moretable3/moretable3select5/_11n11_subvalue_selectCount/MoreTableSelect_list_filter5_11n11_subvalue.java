...
package org.teasoft.exam.moretable3.moretable3select5._11n11_subvalue_selectCount;
...
//		    int count=moreTable.count(province);
		    int count=moreTable.count(province, null);
			Logger.info("moreTable.count(province, null), count=" + count);
