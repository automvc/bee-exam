...
package org.teasoft.exam.moretable3.moretable3select5._11n11_subvalue_selectJson;
...
//			province.setId(1002); //主表条件
			...
			String json="MoreTable do not support selectJson. can use: JacksonJsonUtil.toJson(moreTable.select(entity, 0, 10))";
			Logger.info(json);
			
//			String json=moreTable.selectJson(province, null);
...
//					Logger.info(JacksonJsonUtil.toJson(list1.get(i)));
					Logger.info(JsonUtil.toJson(list1.get(i)));
				}
			}
