...
package org.teasoft.exam.moretable3.moretable3select5._1_11_1_1_1_insert;
 ...
 * @since  3.0.0
 */
public class MoreTableSelect_list_filter5_11111_insert {
...
//			province.setId(1002); //主表条件
			...
			//完成一次操作，就会清结构缓存；不然后来的操作可能设置的对象不一样。 //TODO
...
//	private List listCity;
	...
	public String toString() {
		...
		if(city!=null) {
			str.append(", provinceHistory={").append(provinceHistory.toString()+"}");
		}else {
			str.append(",provinceHistory=null");
		}
