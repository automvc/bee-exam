...
package org.teasoft.exam.moretable3.moretable3select5._1_n11_1_n_1_subvalueList_rewritePaging;
...
//			province.setListCity(listCity);
			...
			List<Province> list1 = moreTable.select(province, 0, 1); //select 查询前10条记录
