...
package org.teasoft.exam.moretable3.moretable3select5._1n1n1_column_condition3;
 ...
 * @since 3.0.0
 */
public class MoreTableSelect_list_filter5_1n1n1_column_condition3 {
...
//			province.setName2("广东省");
			...
			condition.op("name2", Op.eq, null); //主表可以不写表名
			condition.op("province.level", Op.eq, 1); //主表也可以写表名
			condition.op("city.name3", Op.eq, "深圳市");//从表一定要写表名
			
			condition.selectField("id","name2","city.name3","city.remark");
//			condition.selectField("id","name2","city.name");
