...
package org.teasoft.exam.moretable3.moretable3select5._1n1n1_count_sum3;
...
/**
 * 多表查询，带条件
 * select fun, use alias
 * @author Kingstar
 * @since  3.0.0
 */
public class MoreTableSelect_list_filter5_1n1n1_count_sum3 {
...
//			province.setId(1002); //主表条件
			...
			condition.selectField("province.name");
			condition.selectFun(FunctionType.COUNT, "name1", "cityCount");
			condition.selectFun(FunctionType.SUM, "city.id", "citySum");
			condition.groupBy("province.name");
...
//	}
	...
	public String toString() {
		...
		str.append(",name1=").append(name1);
		str.append(",level=").append(level);
		str.append(",remark=").append(remark);
		str.append(",cityCount=").append(cityCount);
		str.append(",citySum=").append(citySum);
		if(listCity!=null) {
			str.append(", listCity=[");
			int i=0;
...
//	@JoinTable3(mainField = { "id" }, subField = { "cityId" }, joinType = JoinType.JOIN, subClass=Town.class)
	@JoinTable(mainField = { "id2" }, subField = { "cityId" }, joinType = JoinType.JOIN, subClass=Town.class)
	private Town town;
