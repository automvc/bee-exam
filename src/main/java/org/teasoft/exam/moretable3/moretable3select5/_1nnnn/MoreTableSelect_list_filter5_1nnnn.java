...
package org.teasoft.exam.moretable3.moretable3select5._1nnnn;
 ...
 * @since  3.0.0
 */
public class MoreTableSelect_list_filter5_1nnnn {
...
class Village implements Serializable {
	...
	public List<Road> getListRoad() {
		return listRoad;
	}

	public void setListRoad(List<Road> listRoad) {
...
//		}
		...
		if(listRoad!=null) {
			...
			for (Road road : listRoad) {
				if(i!=0) str.append(", ");
				i++;
				str.append(" village={").append(road.toString()+"}");
			}
			str.append("]");
		}else {
			str.append(",listRoad=null");
		}
